...
function build {
	...
	if [[ $PLATFORM == 'Darwin' ]]; then
		...
		LIBRARIES="-lluajit-5.1 -lassimp -lportaudio -lfreeimage -lfreetype -lapr-1 -laprutil-1 -force_load $ALLOCOREPATH/build/lib/liballocore.a -force_load $ALLOCOREPATH/build/lib/liballoutil.a externs/libuv/uv.a"
