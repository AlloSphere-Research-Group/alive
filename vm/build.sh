...
function build {
	...
	if [[ $PLATFORM == 'Darwin' ]]; then
		...
		LIBRARIES="-lluajit-5.1 -lassimp -lportaudio -lfreeimage -lfreetype -lapr-1 -laprutil-1 -lzmq -force_load $ALLOCOREPATH/build/lib/liballocore.a -force_load $ALLOCOREPATH/build/lib/liballoutil.a"
		...
		LIBRARIES="-lallocore -lalloutil  -lluajit-5.1 -lGLEW -lGLU -lGL -lglut -lassimp -lportaudio -lrt -lasound -lpthread -lfreeimage -lfreetype -lapr-1 -laprutil-1 -lzmq"
