...
function build {
	...
	if [[ $PLATFORM == 'Darwin' ]]; then
		...
		LIBRARIES="-lluajit-5.1 -lev -lassimp -lportaudio -lfreeimage -lapr-1 -lfreetype -laprutil-1 -force_load $ALLOSYSTEMPATH/build/lib/liballocore.a -force_load $ALLOSYSTEMPATH/build/lib/liballoutil.a -force_load ../externs/libuv/uv.a"
		...
		LIBRARIES="-lallocore -lalloutil -lluajit-5.1 -lev -lGLEW -lGLU -lGL -lglut -lassimp -lportaudio  -lasound -lfreeimage -lfreetype -lapr-1 -laprutil-1 ../externs/libuv/uv.a -lrt -lpthread"
