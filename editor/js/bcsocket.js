...
(function() {
  ...
  BCSocket = function(url, options) {
    var handler, lastErrorCode, lastSession, reconnect, reconnectTime, reconnectTimer, self, session, setState;
    self = this;
    url || (url = 'channel');
    if (url.match(/:\/\//)) {
      url.replace(/^ws/, 'http');
    ...
    handler.channelOpened = function(channel) {
      ...
      return typeof self['onopen'] === "function" ? self['onopen']() : void 0;
    };
    lastErrorCode = null;
    handler.channelError = function(channel, errCode) {
      ...
      return typeof self['onerror'] === "function" ? self['onerror'](message, errCode) : void 0;
    };
    reconnectTimer = null;
    ...
    handler.channelHandleArray = function(channel, message) {
      return typeof self['onmessage'] === "function" ? self['onmessage'](message) : void 0;
    };
    reconnect = function() {
      if (session) {
      ...
      if (typeof self['onconnecting'] === "function") {
        self['onconnecting']();
      }
      clearTimeout(reconnectTimer);
